...
<div class="col-md-12">
	...
	<div class="col-md-4">
		...
		<div class="col-lg-4">
			<span style="font-family: 'sans-serif'; font-weight: normal; position: initial; font-size: 25;"> BAHWAN CYBERTEK</span></div>
...
<div class="col-md-12">
	...
	<div class="col-md-8">
		...
		<h3 align="center" style="font-size: 20; color: orange; align-content: center !important;">Please do not hit refresh or back</h3>
	</div>
	<div class="col-md-2">&nbsp;</div>
</div>
			...
			<form id="checkoutForm" name="checkoutForm" action="CheckoutServlet" method="POST">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="col-lg-6">
							<input class="form-control textWithImage" id="cardNumber" name="cardNumber" size="40" value="4000000000000002">
						</div>
						<div class="col-lg-2">
...
<%--				<div class="col-md-12">
				...
				<div class="col-md-12">
					...
					<div class="col-md-8">
						<div class="col-lg-4">&nbsp;</div>
						<div class="col-lg-6">
							<input type="button" id="payNow" class="btn btn-info" value="Pay Now" onClick="tokenRequest()" />
						</div>
						<div class="col-lg-2">&nbsp;</div>
					</div>
					<div class="col-md-2">&nbsp;</div>
