...
!function () {
    function e(a) {
        try {
            if (navigator.plugins && navigator.plugins.length)for (var b = 0; b < navigator.plugins.length; b++) {
    ...
    function v(a) {
        var b = new Date, c = new Date, i = [p("TF1"), p("015"), function () {
    ...
    function t(a, b, c, d) {
        ...
        for (var e, f = !0; (e = a.indexOf(b)) >= 0 && (d || f);)a = a.substr(0, e) + c + a.substr(e + b.length), f = !1;
        return a
    }
    ...
    var m = {}, n = new Date(2005, 0, 15).getTimezoneOffset(), o = new Date(2005, 6, 15).getTimezoneOffset(), l = [],
        u = {
    ...
    l = {}, m.jscall = function (a) {
        try {
            ...
            a:{
                ...
                if (null === c || "undefined" == typeof c)for (var f = 0; f < document.forms.length; f++)for (var g = document.forms[f], h = 0; h < g.elements.length; h++) {
                    var i = g[h];
                    if (i.name === a || i.id === a) {
                        b = i;
                        break a
    ...
    __namespace: !0, __typeName: "Sys", getName: function () {
        return "Sys"
    }, __upperCaseTypes: {}
    ...
    if ("undefined" != typeof Type && "function" == typeof Type.registerNamespace) Type.registerNamespace(a); else for (var b = window, c = a.split("."), d = 0; d < c.length; d++) {
        var e = c[d], f = b[e];
        f || (f = b[e] = {}), f.__typeName = a, f.__namespace = !0, b = f
    }
}, System.Type.RegisterClass = function (typeName, baseType, interfaceTypes) {
    if ("undefined" != typeof Type && "function" == typeof Type.registerClass) Type.registerClass(typeName, baseType, interfaceTypes); else {
    ...
    if ("undefined" != typeof Type && "function" == typeof Type.registerEnum) Type.registerEnum(type, flags); else {
        var o = eval(type);
    ...
    var d;
    if (b.length > 0)for (d = 0; d < a.length; d++) {
        var e = new Array(b[0]), f = b.slice(1);
...
}, System.Type.RegisterClass("System.Byte"), System.Extensions.Apply.apply(this), System.Type.RegisterNamespace("System.Text"), System.Text.Encoding = function () {
    ...
    var c = new System.Convert.Base64Array, d = a ? a.length : 0;
    ...
    return n
}, System.Type.RegisterNamespace("System"), System.BigInt = function () {
    ...
    function e(a, b, c) {
        var d, e = a.length, f = b.length;
        for (k = f > e + c ? e + c : f, d = f - 1 - c; e > d && d >= 0; d++)if (a[d] > 0)return 1;
    ...
    function p(a, b) {
        var c, d, e, f;
        for (a[0] += b, d = a.length, e = 0, c = 0; d > c; c++)if (e += a[c], f = 0, 0 > e && (f = -(e >> B), e += f * D), a[c] = e & C, e = (e >> B) - f, !e)return
    }
    ...
    function s(a, b) {
        var c, d, e, f;
        if (b)for (d = a.length, e = 0, c = 0; d > c; c++)e += a[c] * b, f = 0, 0 > e && (f = -(e >> B), e += f * D), a[c] = e & C, e = (e >> B) - f
    }
    ...
    function z(a, b, d) {
        ...
        } else for (n(s7, a), o(a, 1); !equalsInt(b, 0);)1 & b[0] && x(a, s7, d), u(b, 2), squareMod_(s7, d)
    }

    function A(a, b, c, d) {
        var e, g, h, i, j, k, l = c.length, m = b.length;
    ...
    t = new Array(0), ss = t, s0 = t, s1 = t, s2 = t, s3 = t, s4 = t, s5 = t, s6 = t, s7 = t, T = t, sa = t, mr_x1 = t, mr_r = t, mr_a = t, eg_v = t, eg_u = t, eg_A = t, eg_B = t, eg_C = t, eg_D = t, md_q1 = t, md_q2 = t, md_q3 = t, md_r = t, md_r1 = t, md_r2 = t, md_tt = t, primes = t, pows = t, s_i = t, s_i2 = t, s_R = t, s_rm = t, s_q = t, s_n1 = t, s_a = t, s_r2 = t, s_n = t, s_b = t, s_d = t, s_x1 = t, s_x2 = t, s_aa = t, rpprb = t, this.ToArray = function (a, b) {
        var c, d, e = new Array;
        if (s6.length != a.length ? s6 = m(a) : n(s6, a), -1 == b)for (c = 0; c < a.length; c++)e.push(a[c]); else for (; !l(s6);)d = u(s6, b), e.push(d);
    ...
    function f(a, b) {
        ...
        } else for (c = 0; q > c; c++)for (l = !0, d(n, o), l = !1, System.Buffer.BlockCopy(n, p, n, 0, m - p), System.Buffer.BlockCopy(a, c, n, m - p, p), e = 0; p > e; e++)b[e + c] = o[e] ^ a[e + c]
    }
    ...
    var j, k = null, l = !1, m = 0, n = new Array, o = new Array, p = 0, q = 0;
    this.InputBlockSize = 0, this.OutputBlockSize = 0, this.CanTransformMultipleBlocks = !0, this.CanReuseTransform = !1, this._Transform = function (a, b) {
        ...
        var d = m - c, e = d > 0 ? d : m, f = new System.Byte(e), g = 1, h = new Array, j = 0;
        switch (k.Padding) {
        ...
        var q = new System.Byte(m * g), r = new System.Byte(m * g);
...
}, System.Type.RegisterClass("System.Security.Cryptography.RNGCryptoServiceProvider"), System.Security.Cryptography.CipherMode = function () {
    ...
    CFB: 4,
    CTS: 5
}, System.Type.RegisterEnum("System.Security.Cryptography.CipherMode"), System.Security.Cryptography.PaddingMode = function () {
    ...
    RsaEsPkcs: 6,
    RsaEsOaep: 7
}, System.Type.RegisterEnum("System.Security.Cryptography.PaddingMode"), System.Security.Cryptography.CryptoStreamMode = function () {
}, System.Security.Cryptography.CryptoStreamMode.prototype = {
    Read: 0,
    Write: 1
}, System.Type.RegisterEnum("System.Security.Cryptography.CryptoStreamMode"), System.Type.RegisterNamespace("System.Security.Cryptography"), System.Security.Cryptography.RSAManaged = function () {
    ...
    function b(a, b) {
        var b = new RegExp("<" + b + ">(.*?)</" + b + ">", "gi"), c = a.match(b);
        if (!c)return null;
        var d = c[0].replace(b, "$1"), e = System.Convert.FromBase64String(d);
        return e
    }
    ...
    function e(a, b, e) {
        for (var f, g = this.KeySize / 8 - (e ? 41 : 11), h = new Array, i = 0; i < b.length / g; i++) {
            ...
            var j = c.call(this, f, e, !0), k = d.call(this, j, a);
            h = h.concat(k)
        }
        return h
    }
    ...
    var f = null, g = null, h = System.BigInt.Utils;
    this.ImportParameters = function (a) {
        ...
        var c = new System.Security.Cryptography.RSAParameters, d = new RegExp("\\s", "gi");
        ...
        var d, f = a.call(this), g = f.Modulus.length;
...
var TCO = new function () {
    this.loadPubKey = function (a, b) {
        var c = e(), d = document.createElement("script"),
        ...
        if (h.fillTokenRequest(g, e), b(h, e)) {
            ...
            var k = encodeURI('{"sellerId" : "' + sellerId + '", "publicKey" : "' + publishableKey + '" , "userPref" : "' + j + '"}'),
                n = tokenRequestUrl + "1/" + sellerId + "/rs/preTokenService?", o = "tcoJsonp", p = "jsonCallback";
    ...
    var a = function (a, b, d) {
        ...
        d.FromXmlString(c);
        var e = System.Text.Encoding.UTF8.GetBytes(a), f = d.Encrypt(e, !1), g = System.Convert.ToBase64String(f);
        return g
    }, i = function () {
        ...
        if (!document.getElementById("2co_user_prefs")) {
            var a = document.body || document.getElementsByTagName("body")[0], b = document.createElement("input");
        ...
        this.tcoUrl = tokenRequestUrl, this.cardType = "CC", this.httpMethod = "GET", this.sellerId = "", this.pubAccessKey = "", this.cardNum = "", this.expMonth = "", this.expYear = "", this.cvv = "", this.preToken = "", this.generatePaymentDetail = function () {
            ...
            if ("object" == typeof a) a.sellerId && a.publishableKey && a.ccNo && a.expMonth && a.expYear && a.cvv ? (this.sellerId = a.sellerId, this.publishableKey = a.publishableKey, this.cardNum = a.ccNo, this.expMonth = a.expMonth, this.expYear = a.expYear, this.cvv = a.cvv) : c(b, "Missing Form Fields", 401); else {
