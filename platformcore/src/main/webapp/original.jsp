...
<form class="form" id="checkoutForm"  name="checkoutForm" action="CheckoutServlet" onsubmit="tokenRequest()"
	...
	<div class="row-fluid">
		<div class="span6 inner-span">
			...
			<table>
				<tr><td width="30%">Name</td><td><input type="text" name="recipient_name" value="Alegra Velava"></input></td></tr>
				<tr><td>Address</td><td><input type="text" name="line1" value="55 East 52nd Street"></input></td></tr>
				<tr><td>Address 1</td><td><input type="text" name="line2" value="21st Floor"></input></td></tr>
				<tr><td>City:</td><td><input type="text" name="city" value="New York" ></input></td></tr>
				<tr><td>State:</td><td><input type="text" name="state" value="NY" ></input></td></tr>
				<tr><td>Postal Code:</td><td><input type="text" name="postal_code" value="10022" ></input></td></tr>
				<input type="hidden" name="currencyCodeType" value=<%=request.getParameter("currencyCodeType2")%>></input>
				<tr><td>Country</td><td>
				...
				<tr><td>Telephone:</td><td><input type="text" name="phoneno" value="" maxlength="12"></input></td></tr>
				...
				<tr><td colspan="2">
					<input  checked id="paypal_payment_option" value="paypal_express" type="radio"
							name="payment_method" title="PayPal Express Check out" class="radio" onchange="changeStatus()"  >
					&nbsp;Pay Pal
				...
				<tr><td colspan="2" valign="top" >
					...
					<input  readonly=""  id="p_method_2Checkout"  value="2checkout" type="radio"
						   name="payment_method" title="2Checkout" class="radio"  onchange="changeStatus()"  >&nbsp;2Checkout</td>
					<td>
							...
							<p>
								...
								<div>
									<label>
										...
										<input id="ccNo" type="text" value="4000000000000002" autocomplete="off"  name="ccNo" />
									</label>
								</div>
								<div>
									<label>
